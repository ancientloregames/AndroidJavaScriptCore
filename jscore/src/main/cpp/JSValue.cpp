...
NATIVE(JSValue, jobject, isEqual)(PARAMS, jlong ctxRef, jlong a, jlong b) {
    ...
    jclass ret = env->FindClass("com/ancientlore/jscore/JSValue$JNIReturnObject");
...
//Java_com_ancientlore_jscore_JSContext_getGroup__J(JNIEnv *env, jobject instance, jlong ctx) {
//}